...
export const select2CountryData: [string] = ["United States", "United Kingdom", "Afghanistan", "Albania",
...
export const select2StateData: [string] = ['Amsterdam', 'Antwerp', 'Athens', 'Barcelona',
