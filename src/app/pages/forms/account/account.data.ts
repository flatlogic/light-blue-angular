export const select2CountryData: string[] = [
...
export const select2StateData: string[] = [
...
export const select2WebsiteAssociateList: string[] = [
  'Admin', 'Main Website'
];

export const select2AccountGroupsList: string[] = [
