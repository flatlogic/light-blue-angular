...
<div class="list-group list-group-lg">
    <a href="#" class="list-group-item animated fadeInDown bg-warning-light">
        <span class="thumb-sm pull-left mr">
            <img class="img-circle" src="assets/img/14.png" alt="...">
        </span>
    ...
    <a href="#" class="list-group-item">
        <span class="thumb-sm pull-left mr">
            <img class="img-circle" src="assets/img/1.png" alt="...">
        </span>
    ...
    <a href="#" class="list-group-item">
        <span class="thumb-sm pull-left mr">
            <img class="img-circle" src="assets/img/2.png" alt="...">
        </span>
    ...
    <a href="#" class="list-group-item">
        <span class="thumb-sm pull-left mr">
            <img class="img-circle" src="assets/img/3.png" alt="...">
        </span>
    ...
    <a href="#" class="list-group-item mb-n-md">
        <span class="thumb-sm pull-left mr">
            <img class="img-circle" src="assets/img/13.png" alt="...">
        </span>
